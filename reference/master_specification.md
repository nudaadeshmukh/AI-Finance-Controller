...
3. **Invariant, enforced at runtime, not just by tests:** every key appearing in any
   ...
   nothing accounted for. This is CLAUDE.md rule 4 ("no third state") enforced at the
...
`results.json` fields, which CLAUDE.md rule 12 reserves for a documented decision, not
