"""Dataset invariant checks - CLAUDE.md Commands section, S6.2/S8.2.
...
real. This module replaces the stub with the four checks CLAUDE.md documents:
...
def validate_run(run_id: str) -> list[str]:
    ...
    # (b) no float anywhere in any source file - CLAUDE.md rule 1, echoed to data
